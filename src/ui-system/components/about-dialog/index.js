	...
	<Dialog>
		...
		<DialogContent>
			...
			<p>
				...
				that generates custom, SVG-based avatars from any username and color
				palette. Feel free to use it in your personal or commercial projects.
			</p>
			<p>
				The playground allows you to change names, generate random color
			...
			<p>
				...
				<a
					target="_blank"
					href="https://ko-fi.com/boringdesginers/"
					rel="noopener noreferrer"
				>
					with a coffee
				</a>{' '}
